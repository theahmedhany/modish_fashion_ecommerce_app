...
class _ApiServices implements ApiServices {
  _ApiServices(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'http://ecommercetest2.runasp.net/api/';
  }
  ...
  @override
  Future<ProductsModel> getProducts(int pageIndex, int pageSize) async {
  ...
  Future<OrderHistoryDetailsModel> getOrdersHistoryDetails(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderHistoryDetailsModel _value;
    try {
      _value = OrderHistoryDetailsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<DeliveryMethodModel>> getDeliveryMethods() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<DeliveryMethodModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'DeliveryMethod',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<DeliveryMethodModel> _value;
    try {
      _value =
          _result.data!
              .map(
                (dynamic i) =>
                    DeliveryMethodModel.fromJson(i as Map<String, dynamic>),
              )
              .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
