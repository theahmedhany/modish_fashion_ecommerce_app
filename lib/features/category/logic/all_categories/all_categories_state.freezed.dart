...
/// @nodoc
abstract class $AllCategoriesStateCopyWith<T, $Res> {
  factory $AllCategoriesStateCopyWith(
    AllCategoriesState<T> value,
    $Res Function(AllCategoriesState<T>) then,
  ) = _$AllCategoriesStateCopyWithImpl<T, $Res, AllCategoriesState<T>>;
}

/// @nodoc
class _$AllCategoriesStateCopyWithImpl<
  T,
  $Res,
  $Val extends AllCategoriesState<T>
>
    implements $AllCategoriesStateCopyWith<T, $Res> {
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$AllCategoriesStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
class _$IdleImpl<T> implements Idle<T> {
  ...
  @override
  String toString() {
    return 'AllCategoriesState<$T>.idle()';
  }
...
abstract class Idle<T> implements AllCategoriesState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$AllCategoriesStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'AllCategoriesState<$T>.loading()';
  }
...
abstract class Loading<T> implements AllCategoriesState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$AllCategoriesStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'AllCategoriesState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements AllCategoriesState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$AllCategoriesStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'AllCategoriesState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements AllCategoriesState<T> {
