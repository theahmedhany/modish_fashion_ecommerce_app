...
abstract class $ProductsStateCopyWith<T, $Res> {
  factory $ProductsStateCopyWith(
    ProductsState<T> value,
    $Res Function(ProductsState<T>) then,
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$ProductsStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
abstract class Idle<T> implements ProductsState<T> {
