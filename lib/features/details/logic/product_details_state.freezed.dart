...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$ProductDetailsStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
abstract class Idle<T> implements ProductDetailsState<T> {
