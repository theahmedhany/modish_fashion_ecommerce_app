...
part of 'delivery_method_state.dart';
...
/// @nodoc
abstract class $DeliveryMethodStateCopyWith<T, $Res> {
  factory $DeliveryMethodStateCopyWith(
    DeliveryMethodState<T> value,
    $Res Function(DeliveryMethodState<T>) then,
  ) = _$DeliveryMethodStateCopyWithImpl<T, $Res, DeliveryMethodState<T>>;
}

/// @nodoc
class _$DeliveryMethodStateCopyWithImpl<
  T,
  $Res,
  $Val extends DeliveryMethodState<T>
>
    implements $DeliveryMethodStateCopyWith<T, $Res> {
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$DeliveryMethodStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
class _$IdleImpl<T> implements Idle<T> {
  ...
  @override
  String toString() {
    return 'DeliveryMethodState<$T>.idle()';
  }
...
abstract class Idle<T> implements DeliveryMethodState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$DeliveryMethodStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'DeliveryMethodState<$T>.loading()';
  }
...
abstract class Loading<T> implements DeliveryMethodState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$DeliveryMethodStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'DeliveryMethodState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements DeliveryMethodState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$DeliveryMethodStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'DeliveryMethodState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements DeliveryMethodState<T> {
